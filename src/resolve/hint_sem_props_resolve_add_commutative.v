...
Lemma infrule_correct_add_commutative:
  forall m1 m2 z s x y, infrule_prop m1 m2 (rule_add_commutative z s x y).
Proof.
  ...
  by apply Int.add_commut.
Qed.
Hint Resolve infrule_correct_add_commutative: InfRuleDb.
