...
Lemma infrule_correct_add_onebit:
  forall m1 m2 z x y, infrule_prop m1 m2 (rule_add_onebit z x y).
Proof.
  ...
  by apply Int_0_xor_add.
Qed.
Hint Resolve infrule_correct_add_onebit: InfRuleDb.
