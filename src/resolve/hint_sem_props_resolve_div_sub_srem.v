...
Lemma infrule_correct_div_sub_srem:
  forall m1 m2 z b a sz x y, infrule_prop m1 m2 (rule_div_sub_srem z b a sz x y).
Proof.
  ...
  by apply Int_divs_mods.
Qed.
Hint Resolve infrule_correct_div_sub_srem: InfRuleDb.
