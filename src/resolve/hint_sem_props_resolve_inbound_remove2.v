...
Lemma infrule_correct_inbound_remove2:
  forall m1 m2 x y pt pa t a idx u v, infrule_prop m1 m2 (rule_inbound_remove2 x y pt pa t a idx u v).
Proof.
...
Qed.
Hint Resolve infrule_correct_inbound_remove2: InfRuleDb.
