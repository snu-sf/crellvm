...
Lemma eqAL_values2GenericValueExt lc1 lc2 td vs olc gl
  (H: eqAL _ lc1 lc2) :
  values2GenericValueExt td vs olc lc1 gl = values2GenericValueExt td vs olc lc2 gl.
Proof.
  induction vs; [done|].
  destruct a. simpl.
...
Proof.
  ...
  - econs; eauto.
    repeat (erewrite <- (eqAL_getOperandValueExt lc1 lc2); [|by eauto]); eauto.
    by erewrite <- eqAL_values2GenericValueExt; eauto.
