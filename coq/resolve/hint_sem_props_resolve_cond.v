...
Lemma cond_same_lsv_prop
  ...
  (Hmem: maydiff_sem lc1 lc2 alpha olc1 olc2 m) :
  forall gvs1 gvs2
    (H1: values2GenericValueExt (CurTargetData cfg1) l olc1 lc1 (Globals cfg1) = ret gvs1)
    (H2: values2GenericValueExt (CurTargetData cfg2) l olc2 lc2 (Globals cfg2) = ret gvs2),
...
Lemma values_ext_updateAddAL_prop
  ...
  values2GenericValueExt (CurTargetData cfg) idxs (updateAddAL GVs olc x g) lc (Globals cfg) =
  values2GenericValueExt (CurTargetData cfg) idxs olc lc (Globals cfg).
Proof.
