...
Lemma infrule_correct_or_commutative:
  forall m1 m2 z s x y, infrule_prop m1 m2 (rule_or_commutative z s x y).
Proof.
  ...
  by apply Int.or_commut.
Qed.
Hint Resolve infrule_correct_or_commutative: InfRuleDb.
