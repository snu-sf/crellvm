...
Definition cond_replace_lessdef_value (x:IdT.t) (y:ValueT.t) (v v':ValueT.t) : bool :=
  ...
  | ValueT.const c1, ValueT.const c2 => my_const_dec c1 c2 (* How about the case, c1 == undef? *)
  | _,_ => false
  end.
...
Definition cond_replace_lessdef (x:IdT.t) (y:ValueT.t) (e e':Expr.t) : bool :=
  ...
  | Expr.extractvalue t1 v1 lc1 u1, Expr.extractvalue t2 v2 lc2 u2 =>
    typ_dec t1 t2 &&
    cond_replace_lessdef_value x y v1 v2 &&
    list_forallb2 my_const_dec lc1 lc2 &&
    typ_dec u1 u2
      ...
      (fun itm => 
        ...
        | (sz,idx) =>
          ...
          | (ValueT.const (const_int sz_i i)) => 
            sz_dec sz sz_i &&
            my_const_dec (const_int sz_i i) (const_int sz_i (INTEGER.of_Z (Size.to_Z sz_i) 0%Z true))
          | _ => false
          end
        end)
      idxlist)
