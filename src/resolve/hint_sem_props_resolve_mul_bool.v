...
Lemma infrule_correct_mul_bool:
  forall m1 m2 z x y, infrule_prop m1 m2 (rule_mul_bool z x y).
Proof.
  ...
  arith_tac.    
  by apply Int_0_and_mul.
Qed.
Hint Resolve infrule_correct_mul_bool: InfRuleDb.
