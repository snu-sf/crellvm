...
Lemma infrule_correct_sub_zext_bool:
  forall m1 m2 x y b sz c c', infrule_prop m1 m2 (rule_sub_zext_bool x y b sz c c').
Proof.
...
Qed.
Hint Resolve infrule_correct_sub_zext_bool: InfRuleDb.
