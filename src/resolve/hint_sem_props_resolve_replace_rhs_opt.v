...
Lemma infrule_correct_replace_rhs_opt:
  forall m1 m2 z x y e e', infrule_prop m1 m2 (rule_replace_rhs_opt z x y e e').
Proof.
...
Qed.
Hint Resolve infrule_correct_replace_rhs_opt: InfRuleDb.
